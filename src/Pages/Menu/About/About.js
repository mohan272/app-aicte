...
import './About.css'
  ...
  const mainFeaturedPost = {
    title: 'About Us',
    image: 'https://www.aicte-india.org/sites/default/files/About%20us.jpg',
      ...
      <ThemeProvider theme={theme}>
        ...
        < MDBContainer maxWidth="lg">
          ...
          <MainFeaturedPost post={mainFeaturedPost} />
            <Typography variant="p" className='about-title'>"Technical education in India contributes a major share to the overall education system and plays a vital role in the social and economic development of our nation."</Typography><br />
            <Typography variant="h3" component="h3">The Organisation</Typography><br />
            <Typography>
